    ...
    <Container className="wrapper min-w-full max-w-full">
      <Row>
        <Col md='10' className="flex flex-col">
          <div className="flex items-center justify-between w-full bg-[#2C6FF4] text-white text-[16px] font-medium p-3 rounded-lg">{t('title')}</div>
          <div className="mt-10 product-details-wrapper flex items-center justify-start">
            ...
            <div className="product-details-container flex flex-col">
              ...
              <ul className="flex flex-col gap-2 m-0 p-0 mt-2">
                <li className="text-[14px] text-[#929292] font-light flex items-center"><div className="bg-[#666666] rounded-full w-[5px] h-[6px] mx-2"></div> Intel LGA 1700 Socket: Supports 13th & 12th Gen Intel Core</li>
                <li className="text-[14px] text-[#929292] font-light flex items-center"><div className="bg-[#666666] rounded-full w-[5px] h-[6px] mx-2"></div> Intel LGA 1700 Socket: Supports 13th & 12th Gen Intel Core</li>
                <li className="text-[14px] text-[#929292] font-light flex items-center"><div className="bg-[#666666] rounded-full w-[5px] h-[6px] mx-2"></div> Intel LGA 1700 Socket: Supports 13th & 12th Gen Intel Core</li>
              </ul>
